...
<div class="landing landing--front">
  <div class="container is-padded-mobile">
    <section class="landing--middle">
      <h4 class="is-size-3-mobile">Freelance</h4>
      <h1 class="is-size-1-mobile">Développeur Créatif</h1>
      <p class="is-size-6-mobile">Pour tous vos projets Web et Mobile,<br/> je vous accompagne et mets en lumière vos idées et votre<br/> visibilité digitale.</p>
      <p class="buttons">
        <a href="/contact" class="button is-large is-success is-rounded">Contactez moi <i class="ld ld-send"></i></a>
        <a target="_target" href="https://github.com/Leoche" class="button is-large is-rounded has-icon">
          <span class="icon">
...
<div class="container is-artistic is-padded-mobile">
  <div class="columns">
    <div class="column content has-text-right">
      <div class="title">
        <h3 class="is-size-3-mobile">Un projet qui vous ressemble</h3>
      </div>
  ...
  <div class="container">
    <div class="columns">
      <div class="column is-content">
        <div class="title is-padded-mobile">
          <h3 class="is-size-3-mobile">Je m'occupe de tout</h3>
